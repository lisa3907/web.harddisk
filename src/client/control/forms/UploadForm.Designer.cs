namespace WebHard.WinCtrl.Forms
{
    partial class UploadDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.filelistGrid = new uBizSoft.UIC.Win.Control.DVX.uGridControl();
            this.btCancel = new uBizSoft.UIC.Win.Control.DVX.uSimpleButton();
            this.uploadWorker = new System.ComponentModel.BackgroundWorker();
            this.cbAutoClose = new uBizSoft.UIC.Win.Control.DVX.uCheckEdit();
            this.pbEntireFiles = new uBizSoft.UIC.Win.Control.uProgressBar();
            this.pbCurrentFile = new uBizSoft.UIC.Win.Control.uProgressBar();
            this.lbTransrate = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
            this.lbThroughTime = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
            this.lbLocation = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
            this.lbRemainder = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
            this.lblRemaind = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
            this.lbSpeed = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
            this.uLabelControl3 = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
            this.lbFileCount = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
            ...
            this.lbTotalSize = new uBizSoft.UIC.Win.Control.DVX.uLabelControl();
        ...
        private uBizSoft.UIC.Win.Control.DVX.uGridControl filelistGrid;
        private uBizSoft.UIC.Win.Control.DVX.uSimpleButton btCancel;
        private System.ComponentModel.BackgroundWorker uploadWorker;
        private uBizSoft.UIC.Win.Control.DVX.uCheckEdit cbAutoClose;
        private uBizSoft.UIC.Win.Control.uProgressBar pbEntireFiles;
        private uBizSoft.UIC.Win.Control.uProgressBar pbCurrentFile;
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl lbTransrate;
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl lbThroughTime;
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl lbLocation;
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl lbRemainder;
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl lblRemaind;
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl lbSpeed;
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl uLabelControl3;
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl lbFileCount;
        ...
        private uBizSoft.UIC.Win.Control.DVX.uLabelControl lbTotalSize;
